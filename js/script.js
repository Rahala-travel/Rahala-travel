...
const encyclopediaAuthors = [
  ...
  { key: 'will-ariel-durant', nameAr: 'ول وآريل ديورانت', nameEn: 'Will & Ariel Durant', img: 'images/will-ariel-durant.jpg' }
];
...
const defaultEncyclopediaBooks = [
  ...
  {
    id: 'enc-ancient-egypt-part3',
    authorKey: 'selim-hassan',
    order: 3,
    category: 'encyclopedia',
    authorAr: 'د. سليم حسن',
    authorEn: 'Dr. Salim Hassan',
    img: 'images/ancient-egypt-encyclopedia-part3-cover.jpg',
    titleAr: 'موسوعة مصر القديمة - الجزء الثالث',
    titleEn: 'Encyclopedia of Ancient Egypt - Part Three',
    excerptAr: 'الجزء الثالث من موسوعة مصر القديمة للمؤرخ والأثري د. سليم حسن، متابعةً تاريخ مصر الفرعونية وحضارتها العريقة في حلقات هذه الموسوعة العلمية الرائدة.',
    excerptEn: 'Part Three of the Encyclopedia of Ancient Egypt by the historian and archaeologist Dr. Salim Hassan, continuing the history and heritage of Pharaonic Egypt in this pioneering scholarly encyclopedia.',
  ...
  {
    id: 'enc-ancient-egypt-part11',
    authorKey: 'selim-hassan',
    order: 11,
    category: 'encyclopedia',
    authorAr: 'د. سليم حسن',
    authorEn: 'Dr. Salim Hassan',
    img: 'images/ancient-egypt-encyclopedia-part11-cover.jpg',
    titleAr: 'موسوعة مصر القديمة - الجزء الحادي عشر',
    titleEn: 'Encyclopedia of Ancient Egypt - Part Eleven',
    excerptAr: 'الجزء الحادي عشر من موسوعة مصر القديمة للمؤرخ والأثري د. سليم حسن، متابعةً تاريخ مصر القديمة وحضارتها في واحد من أجزاء هذه الموسوعة العلمية الرائدة.',
    excerptEn: 'Part Eleven of the Encyclopedia of Ancient Egypt by the historian and archaeologist Dr. Salim Hassan, continuing the history and heritage of ancient Egypt in this pioneering scholarly encyclopedia.',
    contentAr: '<p>موسوعة مصر القديمة — الجزء الحادي عشر، من تأليف المؤرخ والأثري الكبير الدكتور سليم حسن، يستعرض فيه مرحلة جديدة من تاريخ مصر القديمة، مسلطاً الضوء على ما شهدته من تطورات سياسية وحضارية مواصلاً سلسلة هذه الموسوعة العلمية الرائدة.</p>',
    contentEn: '<p>Encyclopedia of Ancient Egypt — Part Eleven, by the great historian and archaeologist Dr. Salim Hassan, presenting a new phase of ancient Egyptian history, highlighting its political and civilizational developments and continuing this pioneering scholarly encyclopedia.</p>',
    pdfUrl: 'books/ancient-egypt-encyclopedia-part11.pdf'
  },
  {
    id: 'enc-ancient-egypt-part12',
    authorKey: 'selim-hassan',
    order: 12,
    category: 'encyclopedia',
    authorAr: 'د. سليم حسن',
    authorEn: 'Dr. Salim Hassan',
    img: 'images/ancient-egypt-encyclopedia-part12-cover.jpg',
    titleAr: 'موسوعة مصر القديمة - الجزء الثاني عشر',
    titleEn: 'Encyclopedia of Ancient Egypt - Part Twelve',
    excerptAr: 'الجزء الثاني عشر من موسوعة مصر القديمة للمؤرخ والأثري د. سليم حسن، متابعةً تاريخ مصر القديمة وحضارتها في واحد من أجزاء هذه الموسوعة العلمية الرائدة.',
    excerptEn: 'Part Twelve of the Encyclopedia of Ancient Egypt by the historian and archaeologist Dr. Salim Hassan, continuing the history and heritage of ancient Egypt in this pioneering scholarly encyclopedia.',
    contentAr: '<p>موسوعة مصر القديمة — الجزء الثاني عشر، من تأليف المؤرخ والأثري الكبير الدكتور سليم حسن، يستعرض فيه مرحلة جديدة من تاريخ مصر القديمة، مسلطاً الضوء على ما شهدته من تطورات سياسية وحضارية مواصلاً سلسلة هذه الموسوعة العلمية الرائدة.</p>',
    contentEn: '<p>Encyclopedia of Ancient Egypt — Part Twelve, by the great historian and archaeologist Dr. Salim Hassan, presenting a new phase of ancient Egyptian history, highlighting its political and civilizational developments and continuing this pioneering scholarly encyclopedia.</p>',
    pdfUrl: 'books/ancient-egypt-encyclopedia-part12.pdf'
  },
  {
    id: 'enc-ancient-egypt-part13',
    authorKey: 'selim-hassan',
    order: 13,
    category: 'encyclopedia',
    authorAr: 'د. سليم حسن',
    authorEn: 'Dr. Salim Hassan',
    img: 'images/ancient-egypt-encyclopedia-part13-cover.jpg',
    titleAr: 'موسوعة مصر القديمة - الجزء الثالث عشر',
    titleEn: 'Encyclopedia of Ancient Egypt - Part Thirteen',
    excerptAr: 'الجزء الثالث عشر من موسوعة مصر القديمة للمؤرخ والأثري د. سليم حسن، متابعةً تاريخ مصر القديمة وحضارتها في واحد من أجزاء هذه الموسوعة العلمية الرائدة.',
    excerptEn: 'Part Thirteen of the Encyclopedia of Ancient Egypt by the historian and archaeologist Dr. Salim Hassan, continuing the history and heritage of ancient Egypt in this pioneering scholarly encyclopedia.',
    contentAr: '<p>موسوعة مصر القديمة — الجزء الثالث عشر، من تأليف المؤرخ والأثري الكبير الدكتور سليم حسن، يستعرض فيه مرحلة جديدة من تاريخ مصر القديمة، مسلطاً الضوء على ما شهدته من تطورات سياسية وحضارية مواصلاً سلسلة هذه الموسوعة العلمية الرائدة.</p>',
    contentEn: '<p>Encyclopedia of Ancient Egypt — Part Thirteen, by the great historian and archaeologist Dr. Salim Hassan, presenting a new phase of ancient Egyptian history, highlighting its political and civilizational developments and continuing this pioneering scholarly encyclopedia.</p>',
    pdfUrl: 'books/ancient-egypt-encyclopedia-part13.pdf'
  },
  {
    id: 'enc-ancient-egypt-part14',
    authorKey: 'selim-hassan',
    order: 14,
    category: 'encyclopedia',
    authorAr: 'د. سليم حسن',
    authorEn: 'Dr. Salim Hassan',
    img: 'images/ancient-egypt-encyclopedia-part14-cover.jpg',
    titleAr: 'موسوعة مصر القديمة - الجزء الرابع عشر: الإسكندر الأكبر وبداية عهد البطالمة في مصر',
    titleEn: 'Encyclopedia of Ancient Egypt - Part Fourteen: Alexander the Great and the Beginning of the Ptolemaic Era in Egypt',
    excerptAr: 'الجزء الرابع عشر من موسوعة مصر القديمة للمؤرخ والأثري د. سليم حسن، يستعرض الإسكندر الأكبر وبداية عهد البطالمة في مصر، ونهاية الحكم الفرعوني المحلي وبداية عصر البطالمة.',
    excerptEn: 'Part Fourteen of the Encyclopedia of Ancient Egypt by the historian and archaeologist Dr. Salim Hassan, covering Alexander the Great and the beginning of the Ptolemaic era in Egypt, marking the end of native Pharaonic rule and the start of the Ptolemaic age.',
    contentAr: '<p>موسوعة مصر القديمة — الجزء الرابع عشر: الإسكندر الأكبر وبداية عهد البطالمة في مصر، من تأليف المؤرخ والأثري الكبير الدكتور سليم حسن، يتناول فيه دخول الإسكندر الأكبر لمصر وتأسيس البطالمة، وما رافقها من تحول في تاريخ البلاد من العصر الفرعوني إلى العصر الإغريقي.</p>',
    contentEn: '<p>Encyclopedia of Ancient Egypt — Part Fourteen: Alexander the Great and the Beginning of the Ptolemaic Era in Egypt, by the great historian and archaeologist Dr. Salim Hassan, covering the entry of Alexander the Great into Egypt and the founding of the Ptolemies, and the accompanying transformation of the country\u2019s history from the Pharaonic to the Greek age.</p>',
    pdfUrl: 'books/ancient-egypt-encyclopedia-part14.pdf'
  },
  {
    id: 'enc-ancient-egypt-part15',
    authorKey: 'selim-hassan',
    order: 15,
    category: 'encyclopedia',
    authorAr: 'د. سليم حسن',
    authorEn: 'Dr. Salim Hassan',
    img: 'images/ancient-egypt-encyclopedia-part15-cover.jpg',
    titleAr: 'موسوعة مصر القديمة - الجزء الخامس عشر: عهد البطالمة',
    titleEn: 'Encyclopedia of Ancient Egypt - Part Fifteen: The Ptolemaic Era',
    excerptAr: 'الجزء الخامس عشر من موسوعة مصر القديمة للمؤرخ والأثري د. سليم حسن، يتناول عهد البطالمة في مصر، وما شهده من تطور سياسي وحضاري حتى نهاية حكمهم.',
    excerptEn: 'Part Fifteen of the Encyclopedia of Ancient Egypt by the historian and archaeologist Dr. Salim Hassan, covering the Ptolemaic era in Egypt and its political and civilizational development until the end of their rule.',
    contentAr: '<p>موسوعة مصر القديمة — الجزء الخامس عشر: عهد البطالمة، من تأليف المؤرخ والأثري الكبير الدكتور سليم حسن، يعرض فيه عصر حكم البطالمة لمصر، وما قاموا به من أعمال عمرانية وحضارية ظلت أثرها حاضراً في تاريخ البلاد.</p>',
    contentEn: '<p>Encyclopedia of Ancient Egypt — Part Fifteen: The Ptolemaic Era, by the great historian and archaeologist Dr. Salim Hassan, presenting the era of Ptolemaic rule over Egypt and the civilizational and urban works whose impact endured in the country\u2019s history.</p>',
    pdfUrl: 'books/ancient-egypt-encyclopedia-part15.pdf'
  },
  {
    id: 'enc-ancient-egypt-part16',
    authorKey: 'selim-hassan',
    order: 16,
    category: 'encyclopedia',
    authorAr: 'د. سليم حسن',
    authorEn: 'Dr. Salim Hassan',
    img: 'images/ancient-egypt-encyclopedia-part16-cover.jpg',
    titleAr: 'موسوعة مصر القديمة - الجزء السادس عشر',
    titleEn: 'Encyclopedia of Ancient Egypt - Part Sixteen',
    excerptAr: 'الجزء السادس عشر من موسوعة مصر القديمة للمؤرخ والأثري د. سليم حسن، متابعةً تاريخ مصر القديمة وحضارتها في واحد من أجزاء هذه الموسوعة العلمية الرائدة.',
    excerptEn: 'Part Sixteen of the Encyclopedia of Ancient Egypt by the historian and archaeologist Dr. Salim Hassan, continuing the history and heritage of ancient Egypt in this pioneering scholarly encyclopedia.',
    contentAr: '<p>موسوعة مصر القديمة — الجزء السادس عشر، من تأليف المؤرخ والأثري الكبير الدكتور سليم حسن، يستعرض فيه مرحلة جديدة من تاريخ مصر القديمة، مسلطاً الضوء على ما شهدته من تطورات سياسية وحضارية مواصلاً سلسلة هذه الموسوعة العلمية الرائدة.</p>',
    contentEn: '<p>Encyclopedia of Ancient Egypt — Part Sixteen, by the great historian and archaeologist Dr. Salim Hassan, presenting a new phase of ancient Egyptian history, highlighting its political and civilizational developments and continuing this pioneering scholarly encyclopedia.</p>',
    pdfUrl: 'books/ancient-egypt-encyclopedia-part16.pdf'
  },
  {
    id: 'enc-ancient-egypt-part17',
    authorKey: 'selim-hassan',
    order: 17,
    category: 'encyclopedia',
    authorAr: 'د. سليم حسن',
    authorEn: 'Dr. Salim Hassan',
    img: 'images/ancient-egypt-encyclopedia-part17-cover.jpg',
    titleAr: 'موسوعة مصر القديمة - الجزء السابع عشر',
    titleEn: 'Encyclopedia of Ancient Egypt - Part Seventeen',
    excerptAr: 'الجزء السابع عشر من موسوعة مصر القديمة للمؤرخ والأثري د. سليم حسن، متابعةً تاريخ مصر القديمة وحضارتها في واحد من أجزاء هذه الموسوعة العلمية الرائدة.',
    excerptEn: 'Part Seventeen of the Encyclopedia of Ancient Egypt by the historian and archaeologist Dr. Salim Hassan, continuing the history and heritage of ancient Egypt in this pioneering scholarly encyclopedia.',
    contentAr: '<p>موسوعة مصر القديمة — الجزء السابع عشر، من تأليف المؤرخ والأثري الكبير الدكتور سليم حسن، يستعرض فيه مرحلة جديدة من تاريخ مصر القديمة، مسلطاً الضوء على ما شهدته من تطورات سياسية وحضارية مواصلاً سلسلة هذه الموسوعة العلمية الرائدة.</p>',
    contentEn: '<p>Encyclopedia of Ancient Egypt — Part Seventeen, by the great historian and archaeologist Dr. Salim Hassan, presenting a new phase of ancient Egyptian history, highlighting its political and civilizational developments and continuing this pioneering scholarly encyclopedia.</p>',
    pdfUrl: 'books/ancient-egypt-encyclopedia-part17.pdf'
  },
  {
    id: 'enc-ancient-egypt-part18',
    authorKey: 'selim-hassan',
    order: 18,
    category: 'encyclopedia',
    authorAr: 'د. سليم حسن',
    authorEn: 'Dr. Salim Hassan',
    img: 'images/ancient-egypt-encyclopedia-part18-cover.jpg',
    titleAr: 'موسوعة مصر القديمة - الجزء الثامن عشر',
    titleEn: 'Encyclopedia of Ancient Egypt - Part Eighteen',
    excerptAr: 'الجزء الثامن عشر من موسوعة مصر القديمة للمؤرخ والأثري د. سليم حسن، متابعةً تاريخ مصر القديمة وحضارتها في واحد من أجزاء هذه الموسوعة العلمية الرائدة.',
    excerptEn: 'Part Eighteen of the Encyclopedia of Ancient Egypt by the historian and archaeologist Dr. Salim Hassan, continuing the history and heritage of ancient Egypt in this pioneering scholarly encyclopedia.',
    contentAr: '<p>موسوعة مصر القديمة — الجزء الثامن عشر، من تأليف المؤرخ والأثري الكبير الدكتور سليم حسن، يستعرض فيه مرحلة جديدة من تاريخ مصر القديمة، مسلطاً الضوء على ما شهدته من تطورات سياسية وحضارية مواصلاً سلسلة هذه الموسوعة العلمية الرائدة.</p>',
    contentEn: '<p>Encyclopedia of Ancient Egypt — Part Eighteen, by the great historian and archaeologist Dr. Salim Hassan, presenting a new phase of ancient Egyptian history, highlighting its political and civilizational developments and continuing this pioneering scholarly encyclopedia.</p>',
pdfUrl: 'books/ancient-egypt-encyclopedia-part18.pdf'
  },
  {
    id: 'enc-story-of-civilization-part01',
    authorKey: 'will-ariel-durant',
    order: 1,
    category: 'encyclopedia',
    authorAr: 'ول وآريل ديورانت',
    authorEn: 'Will & Ariel Durant',
    img: 'images/story-of-civilization-part01-cover.jpg',
    titleAr: 'قصة الحضارة - المجلد الأول - الجزء الأول: نشأة الحضارة',
    titleEn: 'The Story of Civilization - Vol. I (Our Oriental Heritage), Part One',
    excerptAr: 'أحد أجزاء (الجزء 1 من المجلد الأول) من موسوعة قصة الحضارة بقلم ول وآريل ديورانت: نشأة الحضارة، حيث يواصل المؤرخان سرده الرائد لتاريخ الحضارة الإنسانية.',
    excerptEn: 'One of the parts (Part One of Volume I) of The Story of Civilization by Will and Ariel Durant: نشأة الحضارة, continuing their landmark narrative of human history and culture.',
    contentAr: '<p>قصة الحضارة — قصة الحضارة - المجلد الأول - الجزء الأول: نشأة الحضارة، من تأليف ول ديورانت وزوجته آريل ديورانت. في هذا الجزء يواصل المؤلفان مشروعهما الموسوعي الضخم في تأريخ الحضارة الإنسانية، متناولين بعمقٍ وسلاسة قصة حياة البشر وتطور مجتمعاتهم وفنونهم وعلومهم وأديانهم، في سردٍ يجمع بين الدقة العلمية والمتعة الأدبية.</p>',
    contentEn: '<p>The Story of Civilization — The Story of Civilization - Vol. I (Our Oriental Heritage), Part One, by Will Durant and his wife Ariel Durant. In this part the authors continue their monumental survey of human civilization, narrating with depth and elegance the story of human life, the growth of societies, arts, sciences and religions, in a style that unites scholarly precision with literary appeal.</p>',
    pdfUrl: 'books/story-of-civilization-part01.pdf'
  },
  {
    id: 'enc-story-of-civilization-part02',
    authorKey: 'will-ariel-durant',
    order: 2,
    category: 'encyclopedia',
    authorAr: 'ول وآريل ديورانت',
    authorEn: 'Will & Ariel Durant',
    img: 'images/story-of-civilization-part02-cover.jpg',
    titleAr: 'قصة الحضارة - المجلد الأول - الجزء الثاني: الشرق الأدنى',
    titleEn: 'The Story of Civilization - Vol. I (Our Oriental Heritage), Part Two',
    excerptAr: 'أحد أجزاء (الجزء 2 من المجلد الأول) من موسوعة قصة الحضارة بقلم ول وآريل ديورانت: الشرق الأدنى، حيث يواصل المؤرخان سرده الرائد لتاريخ الحضارة الإنسانية.',
    excerptEn: 'One of the parts (Part Two of Volume I) of The Story of Civilization by Will and Ariel Durant: الشرق الأدنى, continuing their landmark narrative of human history and culture.',
    contentAr: '<p>قصة الحضارة — قصة الحضارة - المجلد الأول - الجزء الثاني: الشرق الأدنى، من تأليف ول ديورانت وزوجته آريل ديورانت. في هذا الجزء يواصل المؤلفان مشروعهما الموسوعي الضخم في تأريخ الحضارة الإنسانية، متناولين بعمقٍ وسلاسة قصة حياة البشر وتطور مجتمعاتهم وفنونهم وعلومهم وأديانهم، في سردٍ يجمع بين الدقة العلمية والمتعة الأدبية.</p>',
    contentEn: '<p>The Story of Civilization — The Story of Civilization - Vol. I (Our Oriental Heritage), Part Two, by Will Durant and his wife Ariel Durant. In this part the authors continue their monumental survey of human civilization, narrating with depth and elegance the story of human life, the growth of societies, arts, sciences and religions, in a style that unites scholarly precision with literary appeal.</p>',
    pdfUrl: 'books/story-of-civilization-part02.pdf'
  },
  {
    id: 'enc-story-of-civilization-part03',
    authorKey: 'will-ariel-durant',
    order: 3,
    category: 'encyclopedia',
    authorAr: 'ول وآريل ديورانت',
    authorEn: 'Will & Ariel Durant',
    img: 'images/story-of-civilization-part03-cover.jpg',
    titleAr: 'قصة الحضارة - المجلد الأول - الجزء الثالث: الهند وجيرانها',
    titleEn: 'The Story of Civilization - Vol. I (Our Oriental Heritage), Part Three',
    excerptAr: 'أحد أجزاء (الجزء 3 من المجلد الأول) من موسوعة قصة الحضارة بقلم ول وآريل ديورانت: الهند وجيرانها، حيث يواصل المؤرخان سرده الرائد لتاريخ الحضارة الإنسانية.',
    excerptEn: 'One of the parts (Part Three of Volume I) of The Story of Civilization by Will and Ariel Durant: الهند وجيرانها, continuing their landmark narrative of human history and culture.',
    contentAr: '<p>قصة الحضارة — قصة الحضارة - المجلد الأول - الجزء الثالث: الهند وجيرانها، من تأليف ول ديورانت وزوجته آريل ديورانت. في هذا الجزء يواصل المؤلفان مشروعهما الموسوعي الضخم في تأريخ الحضارة الإنسانية، متناولين بعمقٍ وسلاسة قصة حياة البشر وتطور مجتمعاتهم وفنونهم وعلومهم وأديانهم، في سردٍ يجمع بين الدقة العلمية والمتعة الأدبية.</p>',
    contentEn: '<p>The Story of Civilization — The Story of Civilization - Vol. I (Our Oriental Heritage), Part Three, by Will Durant and his wife Ariel Durant. In this part the authors continue their monumental survey of human civilization, narrating with depth and elegance the story of human life, the growth of societies, arts, sciences and religions, in a style that unites scholarly precision with literary appeal.</p>',
    pdfUrl: 'books/story-of-civilization-part03.pdf'
  },
  {
    id: 'enc-story-of-civilization-part04',
    authorKey: 'will-ariel-durant',
    order: 4,
    category: 'encyclopedia',
    authorAr: 'ول وآريل ديورانت',
    authorEn: 'Will & Ariel Durant',
    img: 'images/story-of-civilization-part04-cover.jpg',
    titleAr: 'قصة الحضارة - المجلد الأول - الجزء الرابع: الشرق الأقصى - الصين',
    titleEn: 'The Story of Civilization - Vol. I (Our Oriental Heritage), Part Four',
    excerptAr: 'أحد أجزاء (الجزء 4 من المجلد الأول) من موسوعة قصة الحضارة بقلم ول وآريل ديورانت: الشرق الأقصى - الصين، حيث يواصل المؤرخان سرده الرائد لتاريخ الحضارة الإنسانية.',
    excerptEn: 'One of the parts (Part Four of Volume I) of The Story of Civilization by Will and Ariel Durant: الشرق الأقصى - الصين, continuing their landmark narrative of human history and culture.',
    contentAr: '<p>قصة الحضارة — قصة الحضارة - المجلد الأول - الجزء الرابع: الشرق الأقصى - الصين، من تأليف ول ديورانت وزوجته آريل ديورانت. في هذا الجزء يواصل المؤلفان مشروعهما الموسوعي الضخم في تأريخ الحضارة الإنسانية، متناولين بعمقٍ وسلاسة قصة حياة البشر وتطور مجتمعاتهم وفنونهم وعلومهم وأديانهم، في سردٍ يجمع بين الدقة العلمية والمتعة الأدبية.</p>',
    contentEn: '<p>The Story of Civilization — The Story of Civilization - Vol. I (Our Oriental Heritage), Part Four, by Will Durant and his wife Ariel Durant. In this part the authors continue their monumental survey of human civilization, narrating with depth and elegance the story of human life, the growth of societies, arts, sciences and religions, in a style that unites scholarly precision with literary appeal.</p>',
    pdfUrl: 'books/story-of-civilization-part04.pdf'
  },
  {
    id: 'enc-story-of-civilization-part05',
    authorKey: 'will-ariel-durant',
    order: 5,
    category: 'encyclopedia',
    authorAr: 'ول وآريل ديورانت',
    authorEn: 'Will & Ariel Durant',
    img: 'images/story-of-civilization-part05-cover.jpg',
    titleAr: 'قصة الحضارة - المجلد الأول - الجزء الخامس: الشرق الأقصى - اليابان',
    titleEn: 'The Story of Civilization - Vol. I (Our Oriental Heritage), Part Five',
    excerptAr: 'أحد أجزاء (الجزء 5 من المجلد الأول) من موسوعة قصة الحضارة بقلم ول وآريل ديورانت: الشرق الأقصى - اليابان، حيث يواصل المؤرخان سرده الرائد لتاريخ الحضارة الإنسانية.',
    excerptEn: 'One of the parts (Part Five of Volume I) of The Story of Civilization by Will and Ariel Durant: الشرق الأقصى - اليابان, continuing their landmark narrative of human history and culture.',
    contentAr: '<p>قصة الحضارة — قصة الحضارة - المجلد الأول - الجزء الخامس: الشرق الأقصى - اليابان، من تأليف ول ديورانت وزوجته آريل ديورانت. في هذا الجزء يواصل المؤلفان مشروعهما الموسوعي الضخم في تأريخ الحضارة الإنسانية، متناولين بعمقٍ وسلاسة قصة حياة البشر وتطور مجتمعاتهم وفنونهم وعلومهم وأديانهم، في سردٍ يجمع بين الدقة العلمية والمتعة الأدبية.</p>',
    contentEn: '<p>The Story of Civilization — The Story of Civilization - Vol. I (Our Oriental Heritage), Part Five, by Will Durant and his wife Ariel Durant. In this part the authors continue their monumental survey of human civilization, narrating with depth and elegance the story of human life, the growth of societies, arts, sciences and religions, in a style that unites scholarly precision with literary appeal.</p>',
    pdfUrl: 'books/story-of-civilization-part05.pdf'
  },
  {
    id: 'enc-story-of-civilization-part06',
    authorKey: 'will-ariel-durant',
    order: 6,
    category: 'encyclopedia',
    authorAr: 'ول وآريل ديورانت',
    authorEn: 'Will & Ariel Durant',
    img: 'images/story-of-civilization-part06-cover.jpg',
    titleAr: 'قصة الحضارة - المجلد الثاني - الجزء الأول: حياة اليونان',
    titleEn: 'The Story of Civilization - Vol. II (The Life of Greece), Part One',
    excerptAr: 'أحد أجزاء (الجزء 1 من المجلد الثاني) من موسوعة قصة الحضارة بقلم ول وآريل ديورانت: حياة اليونان، حيث يواصل المؤرخان سرده الرائد لتاريخ الحضارة الإنسانية.',
    excerptEn: 'One of the parts (Part One of Volume II) of The Story of Civilization by Will and Ariel Durant: حياة اليونان, continuing their landmark narrative of human history and culture.',
    contentAr: '<p>قصة الحضارة — قصة الحضارة - المجلد الثاني - الجزء الأول: حياة اليونان، من تأليف ول ديورانت وزوجته آريل ديورانت. في هذا الجزء يواصل المؤلفان مشروعهما الموسوعي الضخم في تأريخ الحضارة الإنسانية، متناولين بعمقٍ وسلاسة قصة حياة البشر وتطور مجتمعاتهم وفنونهم وعلومهم وأديانهم، في سردٍ يجمع بين الدقة العلمية والمتعة الأدبية.</p>',
    contentEn: '<p>The Story of Civilization — The Story of Civilization - Vol. II (The Life of Greece), Part One, by Will Durant and his wife Ariel Durant. In this part the authors continue their monumental survey of human civilization, narrating with depth and elegance the story of human life, the growth of societies, arts, sciences and religions, in a style that unites scholarly precision with literary appeal.</p>',
    pdfUrl: 'books/story-of-civilization-part06.pdf'
  },
  {
    id: 'enc-story-of-civilization-part07',
    authorKey: 'will-ariel-durant',
    order: 7,
    category: 'encyclopedia',
    authorAr: 'ول وآريل ديورانت',
    authorEn: 'Will & Ariel Durant',
    img: 'images/story-of-civilization-part07-cover.jpg',
    titleAr: 'قصة الحضارة - المجلد الثاني - الجزء الثاني: حياة اليونان',
    titleEn: 'The Story of Civilization - Vol. II (The Life of Greece), Part Two',
    excerptAr: 'أحد أجزاء (الجزء 2 من المجلد الثاني) من موسوعة قصة الحضارة بقلم ول وآريل ديورانت: حياة اليونان، حيث يواصل المؤرخان سرده الرائد لتاريخ الحضارة الإنسانية.',
    excerptEn: 'One of the parts (Part Two of Volume II) of The Story of Civilization by Will and Ariel Durant: حياة اليونان, continuing their landmark narrative of human history and culture.',
    contentAr: '<p>قصة الحضارة — قصة الحضارة - المجلد الثاني - الجزء الثاني: حياة اليونان، من تأليف ول ديورانت وزوجته آريل ديورانت. في هذا الجزء يواصل المؤلفان مشروعهما الموسوعي الضخم في تأريخ الحضارة الإنسانية، متناولين بعمقٍ وسلاسة قصة حياة البشر وتطور مجتمعاتهم وفنونهم وعلومهم وأديانهم، في سردٍ يجمع بين الدقة العلمية والمتعة الأدبية.</p>',
    contentEn: '<p>The Story of Civilization — The Story of Civilization - Vol. II (The Life of Greece), Part Two, by Will Durant and his wife Ariel Durant. In this part the authors continue their monumental survey of human civilization, narrating with depth and elegance the story of human life, the growth of societies, arts, sciences and religions, in a style that unites scholarly precision with literary appeal.</p>',
    pdfUrl: 'books/story-of-civilization-part07.pdf'
  },
  {
    id: 'enc-story-of-civilization-part08',
    authorKey: 'will-ariel-durant',
    order: 8,
    category: 'encyclopedia',
    authorAr: 'ول وآريل ديورانت',
    authorEn: 'Will & Ariel Durant',
    img: 'images/story-of-civilization-part08-cover.jpg',
    titleAr: 'قصة الحضارة - المجلد الثاني - الجزء الثالث: حياة اليونان',
    titleEn: 'The Story of Civilization - Vol. II (The Life of Greece), Part Three',
    excerptAr: 'أحد أجزاء (الجزء 3 من المجلد الثاني) من موسوعة قصة الحضارة بقلم ول وآريل ديورانت: حياة اليونان، حيث يواصل المؤرخان سرده الرائد لتاريخ الحضارة الإنسانية.',
    excerptEn: 'One of the parts (Part Three of Volume II) of The Story of Civilization by Will and Ariel Durant: حياة اليونان, continuing their landmark narrative of human history and culture.',
    contentAr: '<p>قصة الحضارة — قصة الحضارة - المجلد الثاني - الجزء الثالث: حياة اليونان، من تأليف ول ديورانت وزوجته آريل ديورانت. في هذا الجزء يواصل المؤلفان مشروعهما الموسوعي الضخم في تأريخ الحضارة الإنسانية، متناولين بعمقٍ وسلاسة قصة حياة البشر وتطور مجتمعاتهم وفنونهم وعلومهم وأديانهم، في سردٍ يجمع بين الدقة العلمية والمتعة الأدبية.</p>',
    contentEn: '<p>The Story of Civilization — The Story of Civilization - Vol. II (The Life of Greece), Part Three, by Will Durant and his wife Ariel Durant. In this part the authors continue their monumental survey of human civilization, narrating with depth and elegance the story of human life, the growth of societies, arts, sciences and religions, in a style that unites scholarly precision with literary appeal.</p>',
    pdfUrl: 'books/story-of-civilization-part08.pdf'
  },
  {
    id: 'enc-story-of-civilization-part09',
    authorKey: 'will-ariel-durant',
    order: 9,
    category: 'encyclopedia',
    authorAr: 'ول وآريل ديورانت',
    authorEn: 'Will & Ariel Durant',
    img: 'images/story-of-civilization-part09-cover.jpg',
    titleAr: 'قصة الحضارة - المجلد الثالث - الجزء الأول: قيصر والمسيح أو الحضارة الرومانية',
    titleEn: 'The Story of Civilization - Vol. III (Caesar and Christ), Part One',
    excerptAr: 'أحد أجزاء (الجزء 1 من المجلد الثالث) من موسوعة قصة الحضارة بقلم ول وآريل ديورانت: قيصر والمسيح أو الحضارة الرومانية، حيث يواصل المؤرخان سرده الرائد لتاريخ الحضارة الإنسانية.',
    excerptEn: 'One of the parts (Part One of Volume III) of The Story of Civilization by Will and Ariel Durant: قيصر والمسيح أو الحضارة الرومانية, continuing their landmark narrative of human history and culture.',
    contentAr: '<p>قصة الحضارة — قصة الحضارة - المجلد الثالث - الجزء الأول: قيصر والمسيح أو الحضارة الرومانية، من تأليف ول ديورانت وزوجته آريل ديورانت. في هذا الجزء يواصل المؤلفان مشروعهما الموسوعي الضخم في تأريخ الحضارة الإنسانية، متناولين بعمقٍ وسلاسة قصة حياة البشر وتطور مجتمعاتهم وفنونهم وعلومهم وأديانهم، في سردٍ يجمع بين الدقة العلمية والمتعة الأدبية.</p>',
    contentEn: '<p>The Story of Civilization — The Story of Civilization - Vol. III (Caesar and Christ), Part One, by Will Durant and his wife Ariel Durant. In this part the authors continue their monumental survey of human civilization, narrating with depth and elegance the story of human life, the growth of societies, arts, sciences and religions, in a style that unites scholarly precision with literary appeal.</p>',
    pdfUrl: 'books/story-of-civilization-part09.pdf'
  },
  {
    id: 'enc-story-of-civilization-part10',
    authorKey: 'will-ariel-durant',
    order: 10,
    category: 'encyclopedia',
    authorAr: 'ول وآريل ديورانت',
    authorEn: 'Will & Ariel Durant',
    img: 'images/story-of-civilization-part10-cover.jpg',
    titleAr: 'قصة الحضارة - المجلد الثالث - الجزء الثاني: قيصر والمسيح أو الحضارة الرومانية',
    titleEn: 'The Story of Civilization - Vol. III (Caesar and Christ), Part Two',
    excerptAr: 'أحد أجزاء (الجزء 2 من المجلد الثالث) من موسوعة قصة الحضارة بقلم ول وآريل ديورانت: قيصر والمسيح أو الحضارة الرومانية، حيث يواصل المؤرخان سرده الرائد لتاريخ الحضارة الإنسانية.',
    excerptEn: 'One of the parts (Part Two of Volume III) of The Story of Civilization by Will and Ariel Durant: قيصر والمسيح أو الحضارة الرومانية, continuing their landmark narrative of human history and culture.',
    contentAr: '<p>قصة الحضارة — قصة الحضارة - المجلد الثالث - الجزء الثاني: قيصر والمسيح أو الحضارة الرومانية، من تأليف ول ديورانت وزوجته آريل ديورانت. في هذا الجزء يواصل المؤلفان مشروعهما الموسوعي الضخم في تأريخ الحضارة الإنسانية، متناولين بعمقٍ وسلاسة قصة حياة البشر وتطور مجتمعاتهم وفنونهم وعلومهم وأديانهم، في سردٍ يجمع بين الدقة العلمية والمتعة الأدبية.</p>',
    contentEn: '<p>The Story of Civilization — The Story of Civilization - Vol. III (Caesar and Christ), Part Two, by Will Durant and his wife Ariel Durant. In this part the authors continue their monumental survey of human civilization, narrating with depth and elegance the story of human life, the growth of societies, arts, sciences and religions, in a style that unites scholarly precision with literary appeal.</p>',
    pdfUrl: 'books/story-of-civilization-part10.pdf'
  },
  {
    id: 'enc-story-of-civilization-part11',
    authorKey: 'will-ariel-durant',
    order: 11,
    category: 'encyclopedia',
    authorAr: 'ول وآريل ديورانت',
    authorEn: 'Will & Ariel Durant',
    img: 'images/story-of-civilization-part11-cover.jpg',
    titleAr: 'قصة الحضارة - المجلد الثالث - الجزء الثالث: قيصر والمسيح أو الحضارة الرومانية',
    titleEn: 'The Story of Civilization - Vol. III (Caesar and Christ), Part Three',
    excerptAr: 'أحد أجزاء (الجزء 3 من المجلد الثالث) من موسوعة قصة الحضارة بقلم ول وآريل ديورانت: قيصر والمسيح أو الحضارة الرومانية، حيث يواصل المؤرخان سرده الرائد لتاريخ الحضارة الإنسانية.',
    excerptEn: 'One of the parts (Part Three of Volume III) of The Story of Civilization by Will and Ariel Durant: قيصر والمسيح أو الحضارة الرومانية, continuing their landmark narrative of human history and culture.',
    contentAr: '<p>قصة الحضارة — قصة الحضارة - المجلد الثالث - الجزء الثالث: قيصر والمسيح أو الحضارة الرومانية، من تأليف ول ديورانت وزوجته آريل ديورانت. في هذا الجزء يواصل المؤلفان مشروعهما الموسوعي الضخم في تأريخ الحضارة الإنسانية، متناولين بعمقٍ وسلاسة قصة حياة البشر وتطور مجتمعاتهم وفنونهم وعلومهم وأديانهم، في سردٍ يجمع بين الدقة العلمية والمتعة الأدبية.</p>',
    contentEn: '<p>The Story of Civilization — The Story of Civilization - Vol. III (Caesar and Christ), Part Three, by Will Durant and his wife Ariel Durant. In this part the authors continue their monumental survey of human civilization, narrating with depth and elegance the story of human life, the growth of societies, arts, sciences and religions, in a style that unites scholarly precision with literary appeal.</p>',
    pdfUrl: 'books/story-of-civilization-part11.pdf'
  },
  {
    id: 'enc-story-of-civilization-part12',
    authorKey: 'will-ariel-durant',
    order: 12,
    category: 'encyclopedia',
    authorAr: 'ول وآريل ديورانت',
    authorEn: 'Will & Ariel Durant',
    img: 'images/story-of-civilization-part12-cover.jpg',
    titleAr: 'قصة الحضارة - المجلد الرابع - الجزء الأول: عصر الإيمان',
    titleEn: 'The Story of Civilization - Vol. IV (The Age of Faith), Part One',
    excerptAr: 'أحد أجزاء (الجزء 1 من المجلد الرابع) من موسوعة قصة الحضارة بقلم ول وآريل ديورانت: عصر الإيمان، حيث يواصل المؤرخان سرده الرائد لتاريخ الحضارة الإنسانية.',
    excerptEn: 'One of the parts (Part One of Volume IV) of The Story of Civilization by Will and Ariel Durant: عصر الإيمان, continuing their landmark narrative of human history and culture.',
    contentAr: '<p>قصة الحضارة — قصة الحضارة - المجلد الرابع - الجزء الأول: عصر الإيمان، من تأليف ول ديورانت وزوجته آريل ديورانت. في هذا الجزء يواصل المؤلفان مشروعهما الموسوعي الضخم في تأريخ الحضارة الإنسانية، متناولين بعمقٍ وسلاسة قصة حياة البشر وتطور مجتمعاتهم وفنونهم وعلومهم وأديانهم، في سردٍ يجمع بين الدقة العلمية والمتعة الأدبية.</p>',
    contentEn: '<p>The Story of Civilization — The Story of Civilization - Vol. IV (The Age of Faith), Part One, by Will Durant and his wife Ariel Durant. In this part the authors continue their monumental survey of human civilization, narrating with depth and elegance the story of human life, the growth of societies, arts, sciences and religions, in a style that unites scholarly precision with literary appeal.</p>',
    pdfUrl: 'books/story-of-civilization-part12.pdf'
  },
  {
    id: 'enc-story-of-civilization-part13',
    authorKey: 'will-ariel-durant',
    order: 13,
    category: 'encyclopedia',
    authorAr: 'ول وآريل ديورانت',
    authorEn: 'Will & Ariel Durant',
    img: 'images/story-of-civilization-part13-cover.jpg',
    titleAr: 'قصة الحضارة - المجلد الرابع - الجزء الثاني: عصر الإيمان',
    titleEn: 'The Story of Civilization - Vol. IV (The Age of Faith), Part Two',
    excerptAr: 'أحد أجزاء (الجزء 2 من المجلد الرابع) من موسوعة قصة الحضارة بقلم ول وآريل ديورانت: عصر الإيمان، حيث يواصل المؤرخان سرده الرائد لتاريخ الحضارة الإنسانية.',
    excerptEn: 'One of the parts (Part Two of Volume IV) of The Story of Civilization by Will and Ariel Durant: عصر الإيمان, continuing their landmark narrative of human history and culture.',
    contentAr: '<p>قصة الحضارة — قصة الحضارة - المجلد الرابع - الجزء الثاني: عصر الإيمان، من تأليف ول ديورانت وزوجته آريل ديورانت. في هذا الجزء يواصل المؤلفان مشروعهما الموسوعي الضخم في تأريخ الحضارة الإنسانية، متناولين بعمقٍ وسلاسة قصة حياة البشر وتطور مجتمعاتهم وفنونهم وعلومهم وأديانهم، في سردٍ يجمع بين الدقة العلمية والمتعة الأدبية.</p>',
    contentEn: '<p>The Story of Civilization — The Story of Civilization - Vol. IV (The Age of Faith), Part Two, by Will Durant and his wife Ariel Durant. In this part the authors continue their monumental survey of human civilization, narrating with depth and elegance the story of human life, the growth of societies, arts, sciences and religions, in a style that unites scholarly precision with literary appeal.</p>',
    pdfUrl: 'books/story-of-civilization-part13.pdf'
  },
  {
    id: 'enc-story-of-civilization-part14',
    authorKey: 'will-ariel-durant',
    order: 14,
    category: 'encyclopedia',
    authorAr: 'ول وآريل ديورانت',
    authorEn: 'Will & Ariel Durant',
    img: 'images/story-of-civilization-part14-cover.jpg',
    titleAr: 'قصة الحضارة - المجلد الرابع - الجزء الثالث: عصر الإيمان',
    titleEn: 'The Story of Civilization - Vol. IV (The Age of Faith), Part Three',
    excerptAr: 'أحد أجزاء (الجزء 3 من المجلد الرابع) من موسوعة قصة الحضارة بقلم ول وآريل ديورانت: عصر الإيمان، حيث يواصل المؤرخان سرده الرائد لتاريخ الحضارة الإنسانية.',
    excerptEn: 'One of the parts (Part Three of Volume IV) of The Story of Civilization by Will and Ariel Durant: عصر الإيمان, continuing their landmark narrative of human history and culture.',
    contentAr: '<p>قصة الحضارة — قصة الحضارة - المجلد الرابع - الجزء الثالث: عصر الإيمان، من تأليف ول ديورانت وزوجته آريل ديورانت. في هذا الجزء يواصل المؤلفان مشروعهما الموسوعي الضخم في تأريخ الحضارة الإنسانية، متناولين بعمقٍ وسلاسة قصة حياة البشر وتطور مجتمعاتهم وفنونهم وعلومهم وأديانهم، في سردٍ يجمع بين الدقة العلمية والمتعة الأدبية.</p>',
    contentEn: '<p>The Story of Civilization — The Story of Civilization - Vol. IV (The Age of Faith), Part Three, by Will Durant and his wife Ariel Durant. In this part the authors continue their monumental survey of human civilization, narrating with depth and elegance the story of human life, the growth of societies, arts, sciences and religions, in a style that unites scholarly precision with literary appeal.</p>',
    pdfUrl: 'books/story-of-civilization-part14.pdf'
  },
  {
    id: 'enc-story-of-civilization-part15',
    authorKey: 'will-ariel-durant',
    order: 15,
    category: 'encyclopedia',
    authorAr: 'ول وآريل ديورانت',
    authorEn: 'Will & Ariel Durant',
    img: 'images/story-of-civilization-part15-cover.jpg',
    titleAr: 'قصة الحضارة - المجلد الرابع - الجزء الرابع: عصر الإيمان',
    titleEn: 'The Story of Civilization - Vol. IV (The Age of Faith), Part Four',
    excerptAr: 'أحد أجزاء (الجزء 4 من المجلد الرابع) من موسوعة قصة الحضارة بقلم ول وآريل ديورانت: عصر الإيمان، حيث يواصل المؤرخان سرده الرائد لتاريخ الحضارة الإنسانية.',
    excerptEn: 'One of the parts (Part Four of Volume IV) of The Story of Civilization by Will and Ariel Durant: عصر الإيمان, continuing their landmark narrative of human history and culture.',
    contentAr: '<p>قصة الحضارة — قصة الحضارة - المجلد الرابع - الجزء الرابع: عصر الإيمان، من تأليف ول ديورانت وزوجته آريل ديورانت. في هذا الجزء يواصل المؤلفان مشروعهما الموسوعي الضخم في تأريخ الحضارة الإنسانية، متناولين بعمقٍ وسلاسة قصة حياة البشر وتطور مجتمعاتهم وفنونهم وعلومهم وأديانهم، في سردٍ يجمع بين الدقة العلمية والمتعة الأدبية.</p>',
    contentEn: '<p>The Story of Civilization — The Story of Civilization - Vol. IV (The Age of Faith), Part Four, by Will Durant and his wife Ariel Durant. In this part the authors continue their monumental survey of human civilization, narrating with depth and elegance the story of human life, the growth of societies, arts, sciences and religions, in a style that unites scholarly precision with literary appeal.</p>',
    pdfUrl: 'books/story-of-civilization-part15.pdf'
  },
  {
    id: 'enc-story-of-civilization-part16',
    authorKey: 'will-ariel-durant',
    order: 16,
    category: 'encyclopedia',
    authorAr: 'ول وآريل ديورانت',
    authorEn: 'Will & Ariel Durant',
    img: 'images/story-of-civilization-part16-cover.jpg',
    titleAr: 'قصة الحضارة - المجلد الرابع - الجزء الخامس: عصر الإيمان',
    titleEn: 'The Story of Civilization - Vol. IV (The Age of Faith), Part Five',
    excerptAr: 'أحد أجزاء (الجزء 5 من المجلد الرابع) من موسوعة قصة الحضارة بقلم ول وآريل ديورانت: عصر الإيمان، حيث يواصل المؤرخان سرده الرائد لتاريخ الحضارة الإنسانية.',
    excerptEn: 'One of the parts (Part Five of Volume IV) of The Story of Civilization by Will and Ariel Durant: عصر الإيمان, continuing their landmark narrative of human history and culture.',
    contentAr: '<p>قصة الحضارة — قصة الحضارة - المجلد الرابع - الجزء الخامس: عصر الإيمان، من تأليف ول ديورانت وزوجته آريل ديورانت. في هذا الجزء يواصل المؤلفان مشروعهما الموسوعي الضخم في تأريخ الحضارة الإنسانية، متناولين بعمقٍ وسلاسة قصة حياة البشر وتطور مجتمعاتهم وفنونهم وعلومهم وأديانهم، في سردٍ يجمع بين الدقة العلمية والمتعة الأدبية.</p>',
    contentEn: '<p>The Story of Civilization — The Story of Civilization - Vol. IV (The Age of Faith), Part Five, by Will Durant and his wife Ariel Durant. In this part the authors continue their monumental survey of human civilization, narrating with depth and elegance the story of human life, the growth of societies, arts, sciences and religions, in a style that unites scholarly precision with literary appeal.</p>',
    pdfUrl: 'books/story-of-civilization-part16.pdf'
  },
  {
    id: 'enc-story-of-civilization-part17',
    authorKey: 'will-ariel-durant',
    order: 17,
    category: 'encyclopedia',
    authorAr: 'ول وآريل ديورانت',
    authorEn: 'Will & Ariel Durant',
    img: 'images/story-of-civilization-part17-cover.jpg',
    titleAr: 'قصة الحضارة - المجلد الرابع - الجزء السادس: عصر الإيمان',
    titleEn: 'The Story of Civilization - Vol. IV (The Age of Faith), Part Six',
    excerptAr: 'أحد أجزاء (الجزء 6 من المجلد الرابع) من موسوعة قصة الحضارة بقلم ول وآريل ديورانت: عصر الإيمان، حيث يواصل المؤرخان سرده الرائد لتاريخ الحضارة الإنسانية.',
    excerptEn: 'One of the parts (Part Six of Volume IV) of The Story of Civilization by Will and Ariel Durant: عصر الإيمان, continuing their landmark narrative of human history and culture.',
    contentAr: '<p>قصة الحضارة — قصة الحضارة - المجلد الرابع - الجزء السادس: عصر الإيمان، من تأليف ول ديورانت وزوجته آريل ديورانت. في هذا الجزء يواصل المؤلفان مشروعهما الموسوعي الضخم في تأريخ الحضارة الإنسانية، متناولين بعمقٍ وسلاسة قصة حياة البشر وتطور مجتمعاتهم وفنونهم وعلومهم وأديانهم، في سردٍ يجمع بين الدقة العلمية والمتعة الأدبية.</p>',
    contentEn: '<p>The Story of Civilization — The Story of Civilization - Vol. IV (The Age of Faith), Part Six, by Will Durant and his wife Ariel Durant. In this part the authors continue their monumental survey of human civilization, narrating with depth and elegance the story of human life, the growth of societies, arts, sciences and religions, in a style that unites scholarly precision with literary appeal.</p>',
    pdfUrl: 'books/story-of-civilization-part17.pdf'
  },
  {
    id: 'enc-story-of-civilization-part18',
    authorKey: 'will-ariel-durant',
    order: 18,
    category: 'encyclopedia',
    authorAr: 'ول وآريل ديورانت',
    authorEn: 'Will & Ariel Durant',
    img: 'images/story-of-civilization-part18-cover.jpg',
    titleAr: 'قصة الحضارة - المجلد الخامس - الجزء الأول: النهضة',
    titleEn: 'The Story of Civilization - Vol. V (The Renaissance), Part One',
    excerptAr: 'أحد أجزاء (الجزء 1 من المجلد الخامس) من موسوعة قصة الحضارة بقلم ول وآريل ديورانت: النهضة، حيث يواصل المؤرخان سرده الرائد لتاريخ الحضارة الإنسانية.',
    excerptEn: 'One of the parts (Part One of Volume V) of The Story of Civilization by Will and Ariel Durant: النهضة, continuing their landmark narrative of human history and culture.',
    contentAr: '<p>قصة الحضارة — قصة الحضارة - المجلد الخامس - الجزء الأول: النهضة، من تأليف ول ديورانت وزوجته آريل ديورانت. في هذا الجزء يواصل المؤلفان مشروعهما الموسوعي الضخم في تأريخ الحضارة الإنسانية، متناولين بعمقٍ وسلاسة قصة حياة البشر وتطور مجتمعاتهم وفنونهم وعلومهم وأديانهم، في سردٍ يجمع بين الدقة العلمية والمتعة الأدبية.</p>',
    contentEn: '<p>The Story of Civilization — The Story of Civilization - Vol. V (The Renaissance), Part One, by Will Durant and his wife Ariel Durant. In this part the authors continue their monumental survey of human civilization, narrating with depth and elegance the story of human life, the growth of societies, arts, sciences and religions, in a style that unites scholarly precision with literary appeal.</p>',
    pdfUrl: 'books/story-of-civilization-part18.pdf'
  },
  {
    id: 'enc-story-of-civilization-part19',
    authorKey: 'will-ariel-durant',
    order: 19,
    category: 'encyclopedia',
    authorAr: 'ول وآريل ديورانت',
    authorEn: 'Will & Ariel Durant',
    img: 'images/story-of-civilization-part19-cover.jpg',
    titleAr: 'قصة الحضارة - المجلد الخامس - الجزء الثاني: النهضة',
    titleEn: 'The Story of Civilization - Vol. V (The Renaissance), Part Two',
    excerptAr: 'أحد أجزاء (الجزء 2 من المجلد الخامس) من موسوعة قصة الحضارة بقلم ول وآريل ديورانت: النهضة، حيث يواصل المؤرخان سرده الرائد لتاريخ الحضارة الإنسانية.',
    excerptEn: 'One of the parts (Part Two of Volume V) of The Story of Civilization by Will and Ariel Durant: النهضة, continuing their landmark narrative of human history and culture.',
    contentAr: '<p>قصة الحضارة — قصة الحضارة - المجلد الخامس - الجزء الثاني: النهضة، من تأليف ول ديورانت وزوجته آريل ديورانت. في هذا الجزء يواصل المؤلفان مشروعهما الموسوعي الضخم في تأريخ الحضارة الإنسانية، متناولين بعمقٍ وسلاسة قصة حياة البشر وتطور مجتمعاتهم وفنونهم وعلومهم وأديانهم، في سردٍ يجمع بين الدقة العلمية والمتعة الأدبية.</p>',
    contentEn: '<p>The Story of Civilization — The Story of Civilization - Vol. V (The Renaissance), Part Two, by Will Durant and his wife Ariel Durant. In this part the authors continue their monumental survey of human civilization, narrating with depth and elegance the story of human life, the growth of societies, arts, sciences and religions, in a style that unites scholarly precision with literary appeal.</p>',
    pdfUrl: 'books/story-of-civilization-part19.pdf'
  },
  {
    id: 'enc-story-of-civilization-part20',
    authorKey: 'will-ariel-durant',
    order: 20,
    category: 'encyclopedia',
    authorAr: 'ول وآريل ديورانت',
    authorEn: 'Will & Ariel Durant',
    img: 'images/story-of-civilization-part20-cover.jpg',
    titleAr: 'قصة الحضارة - المجلد الخامس - الجزء الثالث: النهضة',
    titleEn: 'The Story of Civilization - Vol. V (The Renaissance), Part Three',
    excerptAr: 'أحد أجزاء (الجزء 3 من المجلد الخامس) من موسوعة قصة الحضارة بقلم ول وآريل ديورانت: النهضة، حيث يواصل المؤرخان سرده الرائد لتاريخ الحضارة الإنسانية.',
    excerptEn: 'One of the parts (Part Three of Volume V) of The Story of Civilization by Will and Ariel Durant: النهضة, continuing their landmark narrative of human history and culture.',
    contentAr: '<p>قصة الحضارة — قصة الحضارة - المجلد الخامس - الجزء الثالث: النهضة، من تأليف ول ديورانت وزوجته آريل ديورانت. في هذا الجزء يواصل المؤلفان مشروعهما الموسوعي الضخم في تأريخ الحضارة الإنسانية، متناولين بعمقٍ وسلاسة قصة حياة البشر وتطور مجتمعاتهم وفنونهم وعلومهم وأديانهم، في سردٍ يجمع بين الدقة العلمية والمتعة الأدبية.</p>',
    contentEn: '<p>The Story of Civilization — The Story of Civilization - Vol. V (The Renaissance), Part Three, by Will Durant and his wife Ariel Durant. In this part the authors continue their monumental survey of human civilization, narrating with depth and elegance the story of human life, the growth of societies, arts, sciences and religions, in a style that unites scholarly precision with literary appeal.</p>',
    pdfUrl: 'books/story-of-civilization-part20.pdf'
  },
  {
    id: 'enc-story-of-civilization-part21',
    authorKey: 'will-ariel-durant',
    order: 21,
    category: 'encyclopedia',
    authorAr: 'ول وآريل ديورانت',
    authorEn: 'Will & Ariel Durant',
    img: 'images/story-of-civilization-part21-cover.jpg',
    titleAr: 'قصة الحضارة - المجلد الخامس - الجزء الرابع: النهضة',
    titleEn: 'The Story of Civilization - Vol. V (The Renaissance), Part Four',
    excerptAr: 'أحد أجزاء (الجزء 4 من المجلد الخامس) من موسوعة قصة الحضارة بقلم ول وآريل ديورانت: النهضة، حيث يواصل المؤرخان سرده الرائد لتاريخ الحضارة الإنسانية.',
    excerptEn: 'One of the parts (Part Four of Volume V) of The Story of Civilization by Will and Ariel Durant: النهضة, continuing their landmark narrative of human history and culture.',
    contentAr: '<p>قصة الحضارة — قصة الحضارة - المجلد الخامس - الجزء الرابع: النهضة، من تأليف ول ديورانت وزوجته آريل ديورانت. في هذا الجزء يواصل المؤلفان مشروعهما الموسوعي الضخم في تأريخ الحضارة الإنسانية، متناولين بعمقٍ وسلاسة قصة حياة البشر وتطور مجتمعاتهم وفنونهم وعلومهم وأديانهم، في سردٍ يجمع بين الدقة العلمية والمتعة الأدبية.</p>',
    contentEn: '<p>The Story of Civilization — The Story of Civilization - Vol. V (The Renaissance), Part Four, by Will Durant and his wife Ariel Durant. In this part the authors continue their monumental survey of human civilization, narrating with depth and elegance the story of human life, the growth of societies, arts, sciences and religions, in a style that unites scholarly precision with literary appeal.</p>',
    pdfUrl: 'books/story-of-civilization-part21.pdf'
  },
  {
    id: 'enc-story-of-civilization-part22',
    authorKey: 'will-ariel-durant',
    order: 22,
    category: 'encyclopedia',
    authorAr: 'ول وآريل ديورانت',
    authorEn: 'Will & Ariel Durant',
    img: 'images/story-of-civilization-part22-cover.jpg',
    titleAr: 'قصة الحضارة - المجلد السادس - الجزء الأول: الإصلاح الديني',
    titleEn: 'The Story of Civilization - Vol. VI (The Reformation), Part One',
    excerptAr: 'أحد أجزاء (الجزء 1 من المجلد السادس) من موسوعة قصة الحضارة بقلم ول وآريل ديورانت: الإصلاح الديني، حيث يواصل المؤرخان سرده الرائد لتاريخ الحضارة الإنسانية.',
    excerptEn: 'One of the parts (Part One of Volume VI) of The Story of Civilization by Will and Ariel Durant: الإصلاح الديني, continuing their landmark narrative of human history and culture.',
    contentAr: '<p>قصة الحضارة — قصة الحضارة - المجلد السادس - الجزء الأول: الإصلاح الديني، من تأليف ول ديورانت وزوجته آريل ديورانت. في هذا الجزء يواصل المؤلفان مشروعهما الموسوعي الضخم في تأريخ الحضارة الإنسانية، متناولين بعمقٍ وسلاسة قصة حياة البشر وتطور مجتمعاتهم وفنونهم وعلومهم وأديانهم، في سردٍ يجمع بين الدقة العلمية والمتعة الأدبية.</p>',
    contentEn: '<p>The Story of Civilization — The Story of Civilization - Vol. VI (The Reformation), Part One, by Will Durant and his wife Ariel Durant. In this part the authors continue their monumental survey of human civilization, narrating with depth and elegance the story of human life, the growth of societies, arts, sciences and religions, in a style that unites scholarly precision with literary appeal.</p>',
  ...
  },
  {
    ...
    authorAr: 'ول وآريل ديورانت',
    authorEn: 'Will & Ariel Durant',
    img: 'images/story-of-civilization-part24-cover.jpg',
    titleAr: 'قصة الحضارة - المجلد السادس - الجزء الثالث: الإصلاح الديني',
    titleEn: 'The Story of Civilization - Vol. VI (The Reformation), Part Three',
    excerptAr: 'أحد أجزاء (الجزء 3 من المجلد السادس) من موسوعة قصة الحضارة بقلم ول وآريل ديورانت: الإصلاح الديني، حيث يواصل المؤرخان سرده الرائد لتاريخ الحضارة الإنسانية.',
    excerptEn: 'One of the parts (Part Three of Volume VI) of The Story of Civilization by Will and Ariel Durant: الإصلاح الديني, continuing their landmark narrative of human history and culture.',
    contentAr: '<p>قصة الحضارة — قصة الحضارة - المجلد السادس - الجزء الثالث: الإصلاح الديني، من تأليف ول ديورانت وزوجته آريل ديورانت. في هذا الجزء يواصل المؤلفان مشروعهما الموسوعي الضخم في تأريخ الحضارة الإنسانية، متناولين بعمقٍ وسلاسة قصة حياة البشر وتطور مجتمعاتهم وفنونهم وعلومهم وأديانهم، في سردٍ يجمع بين الدقة العلمية والمتعة الأدبية.</p>',
    contentEn: '<p>The Story of Civilization — The Story of Civilization - Vol. VI (The Reformation), Part Three, by Will Durant and his wife Ariel Durant. In this part the authors continue their monumental survey of human civilization, narrating with depth and elegance the story of human life, the growth of societies, arts, sciences and religions, in a style that unites scholarly precision with literary appeal.</p>',
    pdfUrl: 'books/story-of-civilization-part24.pdf'
  },
  {
    ...
    authorAr: 'ول وآريل ديورانت',
    authorEn: 'Will & Ariel Durant',
    img: 'images/story-of-civilization-part25-cover.jpg',
    titleAr: 'قصة الحضارة - المجلد السادس - الجزء الرابع: الإصلاح الديني',
    titleEn: 'The Story of Civilization - Vol. VI (The Reformation), Part Four',
    excerptAr: 'أحد أجزاء (الجزء 4 من المجلد السادس) من موسوعة قصة الحضارة بقلم ول وآريل ديورانت: الإصلاح الديني، حيث يواصل المؤرخان سرده الرائد لتاريخ الحضارة الإنسانية.',
    excerptEn: 'One of the parts (Part Four of Volume VI) of The Story of Civilization by Will and Ariel Durant: الإصلاح الديني, continuing their landmark narrative of human history and culture.',
    contentAr: '<p>قصة الحضارة — قصة الحضارة - المجلد السادس - الجزء الرابع: الإصلاح الديني، من تأليف ول ديورانت وزوجته آريل ديورانت. في هذا الجزء يواصل المؤلفان مشروعهما الموسوعي الضخم في تأريخ الحضارة الإنسانية، متناولين بعمقٍ وسلاسة قصة حياة البشر وتطور مجتمعاتهم وفنونهم وعلومهم وأديانهم، في سردٍ يجمع بين الدقة العلمية والمتعة الأدبية.</p>',
    contentEn: '<p>The Story of Civilization — The Story of Civilization - Vol. VI (The Reformation), Part Four, by Will Durant and his wife Ariel Durant. In this part the authors continue their monumental survey of human civilization, narrating with depth and elegance the story of human life, the growth of societies, arts, sciences and religions, in a style that unites scholarly precision with literary appeal.</p>',
    pdfUrl: 'books/story-of-civilization-part25.pdf'
  },
  {
    ...
    authorAr: 'ول وآريل ديورانت',
    authorEn: 'Will & Ariel Durant',
    img: 'images/story-of-civilization-part26-cover.jpg',
    titleAr: 'قصة الحضارة - المجلد السادس - الجزء الخامس: الإصلاح الديني',
    titleEn: 'The Story of Civilization - Vol. VI (The Reformation), Part Five',
    excerptAr: 'أحد أجزاء (الجزء 5 من المجلد السادس) من موسوعة قصة الحضارة بقلم ول وآريل ديورانت: الإصلاح الديني، حيث يواصل المؤرخان سرده الرائد لتاريخ الحضارة الإنسانية.',
    excerptEn: 'One of the parts (Part Five of Volume VI) of The Story of Civilization by Will and Ariel Durant: الإصلاح الديني, continuing their landmark narrative of human history and culture.',
    contentAr: '<p>قصة الحضارة — قصة الحضارة - المجلد السادس - الجزء الخامس: الإصلاح الديني، من تأليف ول ديورانت وزوجته آريل ديورانت. في هذا الجزء يواصل المؤلفان مشروعهما الموسوعي الضخم في تأريخ الحضارة الإنسانية، متناولين بعمقٍ وسلاسة قصة حياة البشر وتطور مجتمعاتهم وفنونهم وعلومهم وأديانهم، في سردٍ يجمع بين الدقة العلمية والمتعة الأدبية.</p>',
    contentEn: '<p>The Story of Civilization — The Story of Civilization - Vol. VI (The Reformation), Part Five, by Will Durant and his wife Ariel Durant. In this part the authors continue their monumental survey of human civilization, narrating with depth and elegance the story of human life, the growth of societies, arts, sciences and religions, in a style that unites scholarly precision with literary appeal.</p>',
    pdfUrl: 'books/story-of-civilization-part26.pdf'
  },
  {
    ...
    authorAr: 'ول وآريل ديورانت',
    authorEn: 'Will & Ariel Durant',
    img: 'images/story-of-civilization-part27-cover.jpg',
    titleAr: 'قصة الحضارة - المجلد السادس - الجزء السادس: الإصلاح الديني',
    titleEn: 'The Story of Civilization - Vol. VI (The Reformation), Part Six',
    excerptAr: 'أحد أجزاء (الجزء 6 من المجلد السادس) من موسوعة قصة الحضارة بقلم ول وآريل ديورانت: الإصلاح الديني، حيث يواصل المؤرخان سرده الرائد لتاريخ الحضارة الإنسانية.',
    excerptEn: 'One of the parts (Part Six of Volume VI) of The Story of Civilization by Will and Ariel Durant: الإصلاح الديني, continuing their landmark narrative of human history and culture.',
    contentAr: '<p>قصة الحضارة — قصة الحضارة - المجلد السادس - الجزء السادس: الإصلاح الديني، من تأليف ول ديورانت وزوجته آريل ديورانت. في هذا الجزء يواصل المؤلفان مشروعهما الموسوعي الضخم في تأريخ الحضارة الإنسانية، متناولين بعمقٍ وسلاسة قصة حياة البشر وتطور مجتمعاتهم وفنونهم وعلومهم وأديانهم، في سردٍ يجمع بين الدقة العلمية والمتعة الأدبية.</p>',
    contentEn: '<p>The Story of Civilization — The Story of Civilization - Vol. VI (The Reformation), Part Six, by Will Durant and his wife Ariel Durant. In this part the authors continue their monumental survey of human civilization, narrating with depth and elegance the story of human life, the growth of societies, arts, sciences and religions, in a style that unites scholarly precision with literary appeal.</p>',
    pdfUrl: 'books/story-of-civilization-part27.pdf'
  },
  {
    ...
    authorAr: 'ول وآريل ديورانت',
    authorEn: 'Will & Ariel Durant',
    img: 'images/story-of-civilization-part28-cover.jpg',
    titleAr: 'قصة الحضارة - المجلد السابع - الجزء الأول: بداية عصر العقل',
    titleEn: 'The Story of Civilization - Vol. VII (The Age of Reason Begins), Part One',
    excerptAr: 'أحد أجزاء (الجزء 1 من المجلد السابع) من موسوعة قصة الحضارة بقلم ول وآريل ديورانت: بداية عصر العقل، حيث يواصل المؤرخان سرده الرائد لتاريخ الحضارة الإنسانية.',
    excerptEn: 'One of the parts (Part One of Volume VII) of The Story of Civilization by Will and Ariel Durant: بداية عصر العقل, continuing their landmark narrative of human history and culture.',
    contentAr: '<p>قصة الحضارة — قصة الحضارة - المجلد السابع - الجزء الأول: بداية عصر العقل، من تأليف ول ديورانت وزوجته آريل ديورانت. في هذا الجزء يواصل المؤلفان مشروعهما الموسوعي الضخم في تأريخ الحضارة الإنسانية، متناولين بعمقٍ وسلاسة قصة حياة البشر وتطور مجتمعاتهم وفنونهم وعلومهم وأديانهم، في سردٍ يجمع بين الدقة العلمية والمتعة الأدبية.</p>',
    contentEn: '<p>The Story of Civilization — The Story of Civilization - Vol. VII (The Age of Reason Begins), Part One, by Will Durant and his wife Ariel Durant. In this part the authors continue their monumental survey of human civilization, narrating with depth and elegance the story of human life, the growth of societies, arts, sciences and religions, in a style that unites scholarly precision with literary appeal.</p>',
    pdfUrl: 'books/story-of-civilization-part28.pdf'
  },
  {
    ...
    authorAr: 'ول وآريل ديورانت',
    authorEn: 'Will & Ariel Durant',
    img: 'images/story-of-civilization-part29-cover.jpg',
    titleAr: 'قصة الحضارة - المجلد السابع - الجزء الثاني: بداية عصر العقل',
    titleEn: 'The Story of Civilization - Vol. VII (The Age of Reason Begins), Part Two',
    excerptAr: 'أحد أجزاء (الجزء 2 من المجلد السابع) من موسوعة قصة الحضارة بقلم ول وآريل ديورانت: بداية عصر العقل، حيث يواصل المؤرخان سرده الرائد لتاريخ الحضارة الإنسانية.',
    excerptEn: 'One of the parts (Part Two of Volume VII) of The Story of Civilization by Will and Ariel Durant: بداية عصر العقل, continuing their landmark narrative of human history and culture.',
    contentAr: '<p>قصة الحضارة — قصة الحضارة - المجلد السابع - الجزء الثاني: بداية عصر العقل، من تأليف ول ديورانت وزوجته آريل ديورانت. في هذا الجزء يواصل المؤلفان مشروعهما الموسوعي الضخم في تأريخ الحضارة الإنسانية، متناولين بعمقٍ وسلاسة قصة حياة البشر وتطور مجتمعاتهم وفنونهم وعلومهم وأديانهم، في سردٍ يجمع بين الدقة العلمية والمتعة الأدبية.</p>',
    contentEn: '<p>The Story of Civilization — The Story of Civilization - Vol. VII (The Age of Reason Begins), Part Two, by Will Durant and his wife Ariel Durant. In this part the authors continue their monumental survey of human civilization, narrating with depth and elegance the story of human life, the growth of societies, arts, sciences and religions, in a style that unites scholarly precision with literary appeal.</p>',
    pdfUrl: 'books/story-of-civilization-part29.pdf'
  },
  {
    ...
    authorAr: 'ول وآريل ديورانت',
    authorEn: 'Will & Ariel Durant',
    img: 'images/story-of-civilization-part30-cover.jpg',
    titleAr: 'قصة الحضارة - المجلد السابع - الجزء الثالث: بداية عصر العقل',
    titleEn: 'The Story of Civilization - Vol. VII (The Age of Reason Begins), Part Three',
    excerptAr: 'أحد أجزاء (الجزء 3 من المجلد السابع) من موسوعة قصة الحضارة بقلم ول وآريل ديورانت: بداية عصر العقل، حيث يواصل المؤرخان سرده الرائد لتاريخ الحضارة الإنسانية.',
    excerptEn: 'One of the parts (Part Three of Volume VII) of The Story of Civilization by Will and Ariel Durant: بداية عصر العقل, continuing their landmark narrative of human history and culture.',
    contentAr: '<p>قصة الحضارة — قصة الحضارة - المجلد السابع - الجزء الثالث: بداية عصر العقل، من تأليف ول ديورانت وزوجته آريل ديورانت. في هذا الجزء يواصل المؤلفان مشروعهما الموسوعي الضخم في تأريخ الحضارة الإنسانية، متناولين بعمقٍ وسلاسة قصة حياة البشر وتطور مجتمعاتهم وفنونهم وعلومهم وأديانهم، في سردٍ يجمع بين الدقة العلمية والمتعة الأدبية.</p>',
    contentEn: '<p>The Story of Civilization — The Story of Civilization - Vol. VII (The Age of Reason Begins), Part Three, by Will Durant and his wife Ariel Durant. In this part the authors continue their monumental survey of human civilization, narrating with depth and elegance the story of human life, the growth of societies, arts, sciences and religions, in a style that unites scholarly precision with literary appeal.</p>',
    pdfUrl: 'books/story-of-civilization-part30.pdf'
  },
  {
    ...
    authorAr: 'ول وآريل ديورانت',
    authorEn: 'Will & Ariel Durant',
    img: 'images/story-of-civilization-part31-cover.jpg',
    titleAr: 'قصة الحضارة - المجلد الثامن - الجزء الأول: عصر لويس الرابع عشر',
    titleEn: 'The Story of Civilization - Vol. VIII (The Age of Louis XIV), Part One',
    excerptAr: 'أحد أجزاء (الجزء 1 من المجلد الثامن) من موسوعة قصة الحضارة بقلم ول وآريل ديورانت: عصر لويس الرابع عشر، حيث يواصل المؤرخان سرده الرائد لتاريخ الحضارة الإنسانية.',
    excerptEn: 'One of the parts (Part One of Volume VIII) of The Story of Civilization by Will and Ariel Durant: عصر لويس الرابع عشر, continuing their landmark narrative of human history and culture.',
    contentAr: '<p>قصة الحضارة — قصة الحضارة - المجلد الثامن - الجزء الأول: عصر لويس الرابع عشر، من تأليف ول ديورانت وزوجته آريل ديورانت. في هذا الجزء يواصل المؤلفان مشروعهما الموسوعي الضخم في تأريخ الحضارة الإنسانية، متناولين بعمقٍ وسلاسة قصة حياة البشر وتطور مجتمعاتهم وفنونهم وعلومهم وأديانهم، في سردٍ يجمع بين الدقة العلمية والمتعة الأدبية.</p>',
    contentEn: '<p>The Story of Civilization — The Story of Civilization - Vol. VIII (The Age of Louis XIV), Part One, by Will Durant and his wife Ariel Durant. In this part the authors continue their monumental survey of human civilization, narrating with depth and elegance the story of human life, the growth of societies, arts, sciences and religions, in a style that unites scholarly precision with literary appeal.</p>',
    pdfUrl: 'books/story-of-civilization-part31.pdf'
  },
  {
    ...
    authorAr: 'ول وآريل ديورانت',
    authorEn: 'Will & Ariel Durant',
    img: 'images/story-of-civilization-part32-cover.jpg',
    titleAr: 'قصة الحضارة - المجلد الثامن - الجزء الثاني: عصر لويس الرابع عشر',
    titleEn: 'The Story of Civilization - Vol. VIII (The Age of Louis XIV), Part Two',
    excerptAr: 'أحد أجزاء (الجزء 2 من المجلد الثامن) من موسوعة قصة الحضارة بقلم ول وآريل ديورانت: عصر لويس الرابع عشر، حيث يواصل المؤرخان سرده الرائد لتاريخ الحضارة الإنسانية.',
    excerptEn: 'One of the parts (Part Two of Volume VIII) of The Story of Civilization by Will and Ariel Durant: عصر لويس الرابع عشر, continuing their landmark narrative of human history and culture.',
    contentAr: '<p>قصة الحضارة — قصة الحضارة - المجلد الثامن - الجزء الثاني: عصر لويس الرابع عشر، من تأليف ول ديورانت وزوجته آريل ديورانت. في هذا الجزء يواصل المؤلفان مشروعهما الموسوعي الضخم في تأريخ الحضارة الإنسانية، متناولين بعمقٍ وسلاسة قصة حياة البشر وتطور مجتمعاتهم وفنونهم وعلومهم وأديانهم، في سردٍ يجمع بين الدقة العلمية والمتعة الأدبية.</p>',
    contentEn: '<p>The Story of Civilization — The Story of Civilization - Vol. VIII (The Age of Louis XIV), Part Two, by Will Durant and his wife Ariel Durant. In this part the authors continue their monumental survey of human civilization, narrating with depth and elegance the story of human life, the growth of societies, arts, sciences and religions, in a style that unites scholarly precision with literary appeal.</p>',
    pdfUrl: 'books/story-of-civilization-part32.pdf'
  },
  {
    ...
    authorAr: 'ول وآريل ديورانت',
    authorEn: 'Will & Ariel Durant',
    img: 'images/story-of-civilization-part33-cover.jpg',
    titleAr: 'قصة الحضارة - المجلد الثامن - الجزء الثالث: عصر لويس الرابع عشر',
    titleEn: 'The Story of Civilization - Vol. VIII (The Age of Louis XIV), Part Three',
    excerptAr: 'أحد أجزاء (الجزء 3 من المجلد الثامن) من موسوعة قصة الحضارة بقلم ول وآريل ديورانت: عصر لويس الرابع عشر، حيث يواصل المؤرخان سرده الرائد لتاريخ الحضارة الإنسانية.',
    excerptEn: 'One of the parts (Part Three of Volume VIII) of The Story of Civilization by Will and Ariel Durant: عصر لويس الرابع عشر, continuing their landmark narrative of human history and culture.',
    contentAr: '<p>قصة الحضارة — قصة الحضارة - المجلد الثامن - الجزء الثالث: عصر لويس الرابع عشر، من تأليف ول ديورانت وزوجته آريل ديورانت. في هذا الجزء يواصل المؤلفان مشروعهما الموسوعي الضخم في تأريخ الحضارة الإنسانية، متناولين بعمقٍ وسلاسة قصة حياة البشر وتطور مجتمعاتهم وفنونهم وعلومهم وأديانهم، في سردٍ يجمع بين الدقة العلمية والمتعة الأدبية.</p>',
    contentEn: '<p>The Story of Civilization — The Story of Civilization - Vol. VIII (The Age of Louis XIV), Part Three, by Will Durant and his wife Ariel Durant. In this part the authors continue their monumental survey of human civilization, narrating with depth and elegance the story of human life, the growth of societies, arts, sciences and religions, in a style that unites scholarly precision with literary appeal.</p>',
    pdfUrl: 'books/story-of-civilization-part33.pdf'
  },
  {
    ...
    authorAr: 'ول وآريل ديورانت',
    authorEn: 'Will & Ariel Durant',
    img: 'images/story-of-civilization-part34-cover.jpg',
    titleAr: 'قصة الحضارة - المجلد الثامن - الجزء الرابع: عصر لويس الرابع عشر',
    titleEn: 'The Story of Civilization - Vol. VIII (The Age of Louis XIV), Part Four',
    excerptAr: 'أحد أجزاء (الجزء 4 من المجلد الثامن) من موسوعة قصة الحضارة بقلم ول وآريل ديورانت: عصر لويس الرابع عشر، حيث يواصل المؤرخان سرده الرائد لتاريخ الحضارة الإنسانية.',
    excerptEn: 'One of the parts (Part Four of Volume VIII) of The Story of Civilization by Will and Ariel Durant: عصر لويس الرابع عشر, continuing their landmark narrative of human history and culture.',
    contentAr: '<p>قصة الحضارة — قصة الحضارة - المجلد الثامن - الجزء الرابع: عصر لويس الرابع عشر، من تأليف ول ديورانت وزوجته آريل ديورانت. في هذا الجزء يواصل المؤلفان مشروعهما الموسوعي الضخم في تأريخ الحضارة الإنسانية، متناولين بعمقٍ وسلاسة قصة حياة البشر وتطور مجتمعاتهم وفنونهم وعلومهم وأديانهم، في سردٍ يجمع بين الدقة العلمية والمتعة الأدبية.</p>',
    contentEn: '<p>The Story of Civilization — The Story of Civilization - Vol. VIII (The Age of Louis XIV), Part Four, by Will Durant and his wife Ariel Durant. In this part the authors continue their monumental survey of human civilization, narrating with depth and elegance the story of human life, the growth of societies, arts, sciences and religions, in a style that unites scholarly precision with literary appeal.</p>',
    pdfUrl: 'books/story-of-civilization-part34.pdf'
  },
  {
    ...
    authorAr: 'ول وآريل ديورانت',
    authorEn: 'Will & Ariel Durant',
    img: 'images/story-of-civilization-part35-cover.jpg',
    titleAr: 'قصة الحضارة - المجلد التاسع - الجزء الأول: عصر فولتير',
    titleEn: 'The Story of Civilization - Vol. IX (The Age of Voltaire), Part One',
    excerptAr: 'أحد أجزاء (الجزء 1 من المجلد التاسع) من موسوعة قصة الحضارة بقلم ول وآريل ديورانت: عصر فولتير، حيث يواصل المؤرخان سرده الرائد لتاريخ الحضارة الإنسانية.',
    excerptEn: 'One of the parts (Part One of Volume IX) of The Story of Civilization by Will and Ariel Durant: عصر فولتير, continuing their landmark narrative of human history and culture.',
    contentAr: '<p>قصة الحضارة — قصة الحضارة - المجلد التاسع - الجزء الأول: عصر فولتير، من تأليف ول ديورانت وزوجته آريل ديورانت. في هذا الجزء يواصل المؤلفان مشروعهما الموسوعي الضخم في تأريخ الحضارة الإنسانية، متناولين بعمقٍ وسلاسة قصة حياة البشر وتطور مجتمعاتهم وفنونهم وعلومهم وأديانهم، في سردٍ يجمع بين الدقة العلمية والمتعة الأدبية.</p>',
    contentEn: '<p>The Story of Civilization — The Story of Civilization - Vol. IX (The Age of Voltaire), Part One, by Will Durant and his wife Ariel Durant. In this part the authors continue their monumental survey of human civilization, narrating with depth and elegance the story of human life, the growth of societies, arts, sciences and religions, in a style that unites scholarly precision with literary appeal.</p>',
    pdfUrl: 'books/story-of-civilization-part35.pdf'
  },
  {
    ...
    authorAr: 'ول وآريل ديورانت',
    authorEn: 'Will & Ariel Durant',
    img: 'images/story-of-civilization-part36-cover.jpg',
    titleAr: 'قصة الحضارة - المجلد التاسع - الجزء الثاني: عصر فولتير',
    titleEn: 'The Story of Civilization - Vol. IX (The Age of Voltaire), Part Two',
    excerptAr: 'أحد أجزاء (الجزء 2 من المجلد التاسع) من موسوعة قصة الحضارة بقلم ول وآريل ديورانت: عصر فولتير، حيث يواصل المؤرخان سرده الرائد لتاريخ الحضارة الإنسانية.',
    excerptEn: 'One of the parts (Part Two of Volume IX) of The Story of Civilization by Will and Ariel Durant: عصر فولتير, continuing their landmark narrative of human history and culture.',
    contentAr: '<p>قصة الحضارة — قصة الحضارة - المجلد التاسع - الجزء الثاني: عصر فولتير، من تأليف ول ديورانت وزوجته آريل ديورانت. في هذا الجزء يواصل المؤلفان مشروعهما الموسوعي الضخم في تأريخ الحضارة الإنسانية، متناولين بعمقٍ وسلاسة قصة حياة البشر وتطور مجتمعاتهم وفنونهم وعلومهم وأديانهم، في سردٍ يجمع بين الدقة العلمية والمتعة الأدبية.</p>',
    contentEn: '<p>The Story of Civilization — The Story of Civilization - Vol. IX (The Age of Voltaire), Part Two, by Will Durant and his wife Ariel Durant. In this part the authors continue their monumental survey of human civilization, narrating with depth and elegance the story of human life, the growth of societies, arts, sciences and religions, in a style that unites scholarly precision with literary appeal.</p>',
    pdfUrl: 'books/story-of-civilization-part36.pdf'
  },
  {
    ...
    authorAr: 'ول وآريل ديورانت',
    authorEn: 'Will & Ariel Durant',
    img: 'images/story-of-civilization-part37-cover.jpg',
    titleAr: 'قصة الحضارة - المجلد التاسع - الجزء الثالث: أوروبا الوسطى',
    titleEn: 'The Story of Civilization - Vol. IX (The Age of Voltaire), Part Three',
    excerptAr: 'أحد أجزاء (الجزء 3 من المجلد التاسع) من موسوعة قصة الحضارة بقلم ول وآريل ديورانت: أوروبا الوسطى، حيث يواصل المؤرخان سرده الرائد لتاريخ الحضارة الإنسانية.',
    excerptEn: 'One of the parts (Part Three of Volume IX) of The Story of Civilization by Will and Ariel Durant: أوروبا الوسطى, continuing their landmark narrative of human history and culture.',
    contentAr: '<p>قصة الحضارة — قصة الحضارة - المجلد التاسع - الجزء الثالث: أوروبا الوسطى، من تأليف ول ديورانت وزوجته آريل ديورانت. في هذا الجزء يواصل المؤلفان مشروعهما الموسوعي الضخم في تأريخ الحضارة الإنسانية، متناولين بعمقٍ وسلاسة قصة حياة البشر وتطور مجتمعاتهم وفنونهم وعلومهم وأديانهم، في سردٍ يجمع بين الدقة العلمية والمتعة الأدبية.</p>',
    contentEn: '<p>The Story of Civilization — The Story of Civilization - Vol. IX (The Age of Voltaire), Part Three, by Will Durant and his wife Ariel Durant. In this part the authors continue their monumental survey of human civilization, narrating with depth and elegance the story of human life, the growth of societies, arts, sciences and religions, in a style that unites scholarly precision with literary appeal.</p>',
    pdfUrl: 'books/story-of-civilization-part37.pdf'
  },
  {
    ...
    authorAr: 'ول وآريل ديورانت',
    authorEn: 'Will & Ariel Durant',
    img: 'images/story-of-civilization-part38-cover.jpg',
    titleAr: 'قصة الحضارة - المجلد التاسع - الجزء الرابع: أوروبا الوسطى',
    titleEn: 'The Story of Civilization - Vol. IX (The Age of Voltaire), Part Four',
    excerptAr: 'أحد أجزاء (الجزء 4 من المجلد التاسع) من موسوعة قصة الحضارة بقلم ول وآريل ديورانت: أوروبا الوسطى، حيث يواصل المؤرخان سرده الرائد لتاريخ الحضارة الإنسانية.',
    excerptEn: 'One of the parts (Part Four of Volume IX) of The Story of Civilization by Will and Ariel Durant: أوروبا الوسطى, continuing their landmark narrative of human history and culture.',
    contentAr: '<p>قصة الحضارة — قصة الحضارة - المجلد التاسع - الجزء الرابع: أوروبا الوسطى، من تأليف ول ديورانت وزوجته آريل ديورانت. في هذا الجزء يواصل المؤلفان مشروعهما الموسوعي الضخم في تأريخ الحضارة الإنسانية، متناولين بعمقٍ وسلاسة قصة حياة البشر وتطور مجتمعاتهم وفنونهم وعلومهم وأديانهم، في سردٍ يجمع بين الدقة العلمية والمتعة الأدبية.</p>',
    contentEn: '<p>The Story of Civilization — The Story of Civilization - Vol. IX (The Age of Voltaire), Part Four, by Will Durant and his wife Ariel Durant. In this part the authors continue their monumental survey of human civilization, narrating with depth and elegance the story of human life, the growth of societies, arts, sciences and religions, in a style that unites scholarly precision with literary appeal.</p>',
    pdfUrl: 'books/story-of-civilization-part38.pdf'
  },
  {
    ...
    authorAr: 'ول وآريل ديورانت',
    authorEn: 'Will & Ariel Durant',
    img: 'images/story-of-civilization-part39-cover.jpg',
    titleAr: 'قصة الحضارة - المجلد العاشر - الجزء الأول: روسو والثورة',
    titleEn: 'The Story of Civilization - Vol. X (Rousseau and Revolution), Part One',
    excerptAr: 'أحد أجزاء (الجزء 1 من المجلد العاشر) من موسوعة قصة الحضارة بقلم ول وآريل ديورانت: روسو والثورة، حيث يواصل المؤرخان سرده الرائد لتاريخ الحضارة الإنسانية.',
    excerptEn: 'One of the parts (Part One of Volume X) of The Story of Civilization by Will and Ariel Durant: روسو والثورة, continuing their landmark narrative of human history and culture.',
    contentAr: '<p>قصة الحضارة — قصة الحضارة - المجلد العاشر - الجزء الأول: روسو والثورة، من تأليف ول ديورانت وزوجته آريل ديورانت. في هذا الجزء يواصل المؤلفان مشروعهما الموسوعي الضخم في تأريخ الحضارة الإنسانية، متناولين بعمقٍ وسلاسة قصة حياة البشر وتطور مجتمعاتهم وفنونهم وعلومهم وأديانهم، في سردٍ يجمع بين الدقة العلمية والمتعة الأدبية.</p>',
    contentEn: '<p>The Story of Civilization — The Story of Civilization - Vol. X (Rousseau and Revolution), Part One, by Will Durant and his wife Ariel Durant. In this part the authors continue their monumental survey of human civilization, narrating with depth and elegance the story of human life, the growth of societies, arts, sciences and religions, in a style that unites scholarly precision with literary appeal.</p>',
    pdfUrl: 'books/story-of-civilization-part39.pdf'
  },
  {
    ...
    authorAr: 'ول وآريل ديورانت',
    authorEn: 'Will & Ariel Durant',
    img: 'images/story-of-civilization-part40-cover.jpg',
    titleAr: 'قصة الحضارة - المجلد العاشر - الجزء الثاني: الجنوب الكاثوليكي',
    titleEn: 'The Story of Civilization - Vol. X (Rousseau and Revolution), Part Two',
    excerptAr: 'أحد أجزاء (الجزء 2 من المجلد العاشر) من موسوعة قصة الحضارة بقلم ول وآريل ديورانت: الجنوب الكاثوليكي، حيث يواصل المؤرخان سرده الرائد لتاريخ الحضارة الإنسانية.',
    excerptEn: 'One of the parts (Part Two of Volume X) of The Story of Civilization by Will and Ariel Durant: الجنوب الكاثوليكي, continuing their landmark narrative of human history and culture.',
    contentAr: '<p>قصة الحضارة — قصة الحضارة - المجلد العاشر - الجزء الثاني: الجنوب الكاثوليكي، من تأليف ول ديورانت وزوجته آريل ديورانت. في هذا الجزء يواصل المؤلفان مشروعهما الموسوعي الضخم في تأريخ الحضارة الإنسانية، متناولين بعمقٍ وسلاسة قصة حياة البشر وتطور مجتمعاتهم وفنونهم وعلومهم وأديانهم، في سردٍ يجمع بين الدقة العلمية والمتعة الأدبية.</p>',
    contentEn: '<p>The Story of Civilization — The Story of Civilization - Vol. X (Rousseau and Revolution), Part Two, by Will Durant and his wife Ariel Durant. In this part the authors continue their monumental survey of human civilization, narrating with depth and elegance the story of human life, the growth of societies, arts, sciences and religions, in a style that unites scholarly precision with literary appeal.</p>',
  ...
  },
  {
    ...
    authorAr: 'ول وآريل ديورانت',
    authorEn: 'Will & Ariel Durant',
    img: 'images/story-of-civilization-part42-cover.jpg',
    titleAr: 'قصة الحضارة - المجلد العاشر - الجزء الرابع: روسو والثورة',
    titleEn: 'The Story of Civilization - Vol. X (Rousseau and Revolution), Part Four',
    excerptAr: 'أحد أجزاء (الجزء 4 من المجلد العاشر) من موسوعة قصة الحضارة بقلم ول وآريل ديورانت: روسو والثورة، حيث يواصل المؤرخان سرده الرائد لتاريخ الحضارة الإنسانية.',
    excerptEn: 'One of the parts (Part Four of Volume X) of The Story of Civilization by Will and Ariel Durant: روسو والثورة, continuing their landmark narrative of human history and culture.',
    contentAr: '<p>قصة الحضارة — قصة الحضارة - المجلد العاشر - الجزء الرابع: روسو والثورة، من تأليف ول ديورانت وزوجته آريل ديورانت. في هذا الجزء يواصل المؤلفان مشروعهما الموسوعي الضخم في تأريخ الحضارة الإنسانية، متناولين بعمقٍ وسلاسة قصة حياة البشر وتطور مجتمعاتهم وفنونهم وعلومهم وأديانهم، في سردٍ يجمع بين الدقة العلمية والمتعة الأدبية.</p>',
    contentEn: '<p>The Story of Civilization — The Story of Civilization - Vol. X (Rousseau and Revolution), Part Four, by Will Durant and his wife Ariel Durant. In this part the authors continue their monumental survey of human civilization, narrating with depth and elegance the story of human life, the growth of societies, arts, sciences and religions, in a style that unites scholarly precision with literary appeal.</p>',
    pdfUrl: 'books/story-of-civilization-part42.pdf'
  },
  {
    ...
    authorAr: 'ول وآريل ديورانت',
    authorEn: 'Will & Ariel Durant',
    img: 'images/story-of-civilization-part43-cover.jpg',
    titleAr: 'قصة الحضارة - الفهارس - الجزء الأول',
    titleEn: 'The Story of Civilization - Index Part One',
    excerptAr: 'الفهارس الموحدة لموسوعة قصة الحضارة بقلم ول وآريل ديورانت، تتضمن الفهارس التفصيلية لأسماء الأعلام والأماكن والموضوعات الواردة في الأجزاء كافة، عوناً للباحث والقارئ على التنقل في هذا التأريخ الجامع للحضارة الإنسانية.',
    excerptEn: 'The comprehensive indexes of The Story of Civilization by Will and Ariel Durant, covering persons, places and subjects across all volumes as a guide for readers and scholars of this monumental survey of human civilization.',
    contentAr: '<p>قصة الحضارة — قصة الحضارة - الفهارس - الجزء الأول، بقلم المؤرخين الأمريكيين ول ديورانت وزوجته آريل ديورانت، وهو المجلد التذييلي الذي يجمع الفهارس التفصيلية للموسوعة، فيساعد القارئ والباحث على الوصول السريع إلى أعلام الحضارة وأماكنها وموضوعاتها عبر أجزائها كافة.</p>',
    contentEn: '<p>The Story of Civilization — The Story of Civilization - Index Part One, by the American historians Will Durant and his wife Ariel Durant. This supplemental volume gathers the detailed indexes of the entire series, enabling readers and scholars to quickly locate the great names, places and subjects across all its parts.</p>',
    pdfUrl: 'books/story-of-civilization-part43.pdf'
  },
  {
    ...
    authorAr: 'ول وآريل ديورانت',
    authorEn: 'Will & Ariel Durant',
    img: 'images/story-of-civilization-part44-cover.jpg',
    titleAr: 'قصة الحضارة - الفهارس - الجزء الثاني',
    titleEn: 'The Story of Civilization - Index Part Two',
    excerptAr: 'الفهارس الموحدة لموسوعة قصة الحضارة بقلم ول وآريل ديورانت، تتضمن الفهارس التفصيلية لأسماء الأعلام والأماكن والموضوعات الواردة في الأجزاء كافة، عوناً للباحث والقارئ على التنقل في هذا التأريخ الجامع للحضارة الإنسانية.',
    excerptEn: 'The comprehensive indexes of The Story of Civilization by Will and Ariel Durant, covering persons, places and subjects across all volumes as a guide for readers and scholars of this monumental survey of human civilization.',
    contentAr: '<p>قصة الحضارة — قصة الحضارة - الفهارس - الجزء الثاني، بقلم المؤرخين الأمريكيين ول ديورانت وزوجته آريل ديورانت، وهو المجلد التذييلي الذي يجمع الفهارس التفصيلية للموسوعة، فيساعد القارئ والباحث على الوصول السريع إلى أعلام الحضارة وأماكنها وموضوعاتها عبر أجزائها كافة.</p>',
    contentEn: '<p>The Story of Civilization — The Story of Civilization - Index Part Two, by the American historians Will Durant and his wife Ariel Durant. This supplemental volume gathers the detailed indexes of the entire series, enabling readers and scholars to quickly locate the great names, places and subjects across all its parts.</p>',
    pdfUrl: 'books/story-of-civilization-part44.pdf'
  }
];
...
function getCategoryInfo(catKey, lang) {
  ...
  const mapping = {
    ...
    islamic: {
      label: isAr ? 'تاريخ اسلامي' : 'Islamic Egypt',
      icon: '🕌',
