...
const translations = {
  ar: {
    ...
    cat_opt_modern: "🏙️ تاريخ الحديث (Modern Egypt)",
  ...
  en: {
    ...
    cat_opt_modern: "🏙️ Modern Egypt (تاريخ الحديث)",
...
function getCategoryInfo(catKey, lang) {
  ...
  const mapping = {
    ...
    modern: {
      label: isAr ? 'تاريخ الحديث' : 'Modern Egypt',
      icon: '🏙️',
