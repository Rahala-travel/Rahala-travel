...
function initNewsTicker() {
  ...
  const tickerItems = {
    ar: [
      ...
      { text: 'تأسست رحّالة عبر التاريخ في سبتمبر 2023 بشغف أصيل للتراث', badge: null },
    ],
    en: [
      ...
      { text: 'Rahala Through History was founded in September 2023 with genuine heritage passion', badge: null },
    ]
  };
